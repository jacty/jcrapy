...
from Jcrapy import twisted_version
...
class JcrapyClientTLSOptions(ClientTLSOptions):
    """
    ...
    def __init__(self, hostname, ctx, verbose_logging=False):
        print('JcrapyClientTLSOptions.__init__')
        return
        super(ScrapyClientTLSOptions, self).__init__(hostname, ctx)
        self.verbose_logging = verbose_logging

    def _identityVerifyingInfoCallback(self, connection, where, ret):
        print('JcrapyClientTLSOptions._identityVerifyingInfoCallback')
        return
