...
from Jcrapy.core.downloader.tls import JcrapyClientTLSOptions, DEFAULT_CIPHERS
...
class JcrapyClientContextFactory(BrowserLikePolicyForHTTPS):
    ...
    def getCertificateOptions(self):
        print('JcrapyClientContextFactory.getCertificateOptions')
        return
    ...
    def getContext(self, hostname=None, port=None):
        print('JcrapyClientContextFactory.getContext')
        return self.getCertificateOptions().getContext()

    def creatorForNetloc(self, hostname, port):
        print('JcrapyClientContextFactory.creatorForNetloc')
        return
...
@implementer(IPolicyForHTTPS)
class BrowserLikeContextFactory(JcrapyClientContextFactory):
    """
    ...
    """
    def creatorForNetloc(self, hostname, port):
        print('BrowserLikeContextFactory.creatorForNetloc')
        return
